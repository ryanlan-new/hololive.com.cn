...
echo -e "Web Admin:   https://$DOMAIN/secret-admin-entrance/webadmin"
echo "=========================================================="
echo -e "PocketBase Superuser: ${GREEN}$EMAIL${NC}"
echo -e "Superuser Password:   ${GREEN}$SUPERUSER_PASS${NC}"
echo "=========================================================="
echo -e "Web Default Admin:    ${GREEN}admin@local.dev${NC}"
echo -e "Web Default Password: ${GREEN}password123456${NC}"
echo "=========================================================="
